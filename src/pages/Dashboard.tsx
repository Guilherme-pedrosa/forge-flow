          ...
          <div className="rounded-xl border-2 border-pink-500/30 bg-gradient-to-br from-pink-500/5 via-card to-card overflow-hidden shadow-md">
            <div className="px-5 py-4 border-b border-pink-500/20 flex items-center justify-between bg-pink-500/5">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-sm font-bold text-foreground">🎂 Aniversários Próximos</h3>
            ...
            {data.upcomingBirthdays.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-10 text-muted-foreground">
                <Cake className="h-8 w-8 mb-2 text-pink-300" />
                <p className="text-sm font-medium">Nenhum aniversário nos próximos 30 dias</p>
                <p className="text-xs text-muted-foreground mt-0.5">Cadastre a data de nascimento dos clientes</p>
              </div>
            ) : (
              <div className="divide-y divide-border">
                {data.upcomingBirthdays.map((c: any) => (
                  <div key={c.id} className="px-5 py-3.5 flex items-center justify-between hover:bg-pink-500/5 transition-colors">
